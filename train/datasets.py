...
def SimuHeatDataset(
    ...
    data_statistic_dict = {
        '1000.0': {
            'mean': (97.11424603719144,),
            'std': (48.30308744497137,),
            'min': 10,  # 19.99999943517713
            'max': 225,  # 215.15793789846788
        },
        '10.0': {
            'mean': (190.3908416744434,),
            'std': (6.742437062639392,),
            'min': 166,  # 176.8074126767794
            'max': 260,  # 250.7649458405764
        },
    }
