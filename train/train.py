...
if __name__ == '__main__':
    ...
    parser.add_argument("--worker", "-wk", type=int, default=1, help="dataloader worker")
    ...
    # path
    task_path = os.path.join(train_save_path, utils.name_folder(args['brief']))
    ...
    # load config
    dataset_name = args['train_dataset_root']
